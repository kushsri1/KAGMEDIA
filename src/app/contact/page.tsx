      ...
      <div className="md:flex items-start justify-center md:py-20 px-6">
        ...
        <div className="border-white rounded-md border-[2px] p-5">
          <form onSubmit={handleSubmit} action="" method="post" className="space-y-2">
            ...
            <button type="submit" disabled={isSubmitting} className="border-white border-[2px] rounded-xl px-8 mt-4 hover:bg-white hover:text-black transition-ease-in duration-[0.3s] py-2 text-white">{isSubmitting ? "Submiiting..." : "Submit"} </button>
            {submitStatus && (<div className="text-center text-sm mt-2 text-white">
              {submitStatus}
            </div>)}
          </form>
        </div>
